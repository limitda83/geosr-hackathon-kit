...
(function() {{
  ...
  s.textContent = `
    ...
    #chat-head {{
      background: #041529; color: #e8f4f8;
    ...
    .cm-user {{
      ...
      max-width:83%; word-break:keep-all;
    }}
    .cm-bot {{
      ...
      max-width:83%; border:1px solid rgba(0,194,212,0.1); word-break:keep-all;
    }}
    ...
    #chat-inp:focus {{ border-color:#00c2d4; }}
