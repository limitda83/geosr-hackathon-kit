...
사용법 (저장소 루트에서):
  ...
  예) python src/run_pipeline.py data/khoa_sst data/sst/hot data/sst/persistence
...
def main():
    ...
    hot_dir = sys.argv[2] if len(sys.argv) > 2 else "data/sst/hot"
    persist_dir = sys.argv[3] if len(sys.argv) > 3 else "data/sst/persistence"
