...
기본 동작:
  인자 없이 실행하면 2025-07-01 ~ 2025-08-31 자료를 ./data/khoa_sst 폴더에 받습니다.
  이미 받은(정상 크기) 파일은 건너뜁니다(이어받기). 오류(작은 HTML 등)는 자동 삭제 후 재시도 대상.

사용 예:
  python src/download_khoa_sst.py
  python src/download_khoa_sst.py --start 2025-07-01 --end 2025-08-31 --out ./data/khoa_sst
...
def parse_args(argv=None):
    ...
    p.add_argument("--out", default="./data/khoa_sst", help="저장 폴더 (기본 ./data/khoa_sst)")
